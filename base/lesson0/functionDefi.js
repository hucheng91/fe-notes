...
// 定义
    ...
    // 表达式
        ...
        var a = {
            sayName: function(){console.log("a")}
        }
        a.sayName();
        var array = [
            function(){
    ...
    // 2种声明方式特点在具体业务中的用处
         ...
         // 声明式特点，我们可以把代码抽成很多个function 放在尾部，这样一看function 就知道是做什么的 eg：
                ...
                /** 上面这段代码 意思是根据 页面参数 查询数据，但看着这些代码上面很大一部分是组装ajax的查询参数，一看到initPage这个方法
                不能直观的明白这个function 的语义 ，变换成下面这样后，把组装 ajax 参数拆成一个 getParam 的 function ，
    ...
    // 命令规范
        ...
        //通常已动词为前缀，第一个字母小写，一般用like_this(),
        //这种下划线或者驼峰命名，函数内部函数一般用_开头
